...
## Enter parameters 
After specifying the model, users have to enter the values of all parameters. No matter which model is selected, the set of parameters is the same. 
...
![Check estimation](estimation.gif)
...
![New realisation](new_realisation.gif)
